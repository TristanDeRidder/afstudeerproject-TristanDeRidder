...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    PageContent: Schema.Attribute.DynamicZone<
      ['blocks.header', 'blocks.rich-text-image', 'blocks.why', 'blocks.card']
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiBusinessBusiness extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    PageContent: Schema.Attribute.DynamicZone<
      ['blocks.header', 'blocks.rich-text']
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiRepairorderRepairorder extends Struct.CollectionTypeSchema {
  collectionName: 'repairorders';
  info: {
    description: '';
    displayName: 'Repairorder';
    pluralName: 'repairorders';
    singularName: 'repairorder';
  };
  options: {
    draftAndPublish: true;
  };
