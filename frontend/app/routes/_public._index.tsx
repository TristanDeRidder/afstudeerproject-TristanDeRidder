...
export default function Index() {
  ...
  return (
    <div className="flex flex-col gap-10 2xl:gap-16">
      {/* Hero Section */}
      <div className="px-5 md:px-10 lg:px-32 xl:px-40 2xl:px-56 flex flex-col justify-center gap-8 2xl:gap-12">
        <PrimaryTitle
          title="Een snelle herstelling voor uw toestel"
          subtitle=""
        />

        <div className="w-full max-w-screen-xl flex flex-col md:flex-row justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-12 bg-primary px-4 py-4 md:px-8 lg:px-12 xl:px-16 rounded-3xl md:rounded-lg mx-auto overflow-hidden">
          <RepairCard
