...
import { getPaymentPage } from "../core/modules/SingleTypes/payment/api";
...
export const meta: MetaFunction = () => {
  return [
    { title: "Klantendienst - Betaling | Fixit Aalst" },
    {
      name: "description",
      content:
...
export default function Payment() {
  const { payment } = useLoaderData() as LoaderData;

  if (!payment || !payment.PageContent) {
    return (
  ...
  return (
    <div className="space-y-6 px-5 md:px-10 lg:px-32 w-2/3 mx-auto">
      {payment.PageContent.map((block: any) => {
