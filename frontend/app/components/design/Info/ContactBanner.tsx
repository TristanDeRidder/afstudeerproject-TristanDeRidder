export default function ContactBanner() {    
    return (
      <section className="bg-secondary text-white px-10 py-8 flex flex-col lg:flex-row justify-between items-center gap-8 mx-5 lg:mx-32 rounded-md">
        <div>
          <h2 className="text-4xl lg:text-5xl text-center lg:text-left w-full">
            Bel of kom even langs
          </h2>
          <div className="flex flex-col items-center gap-1 md:flex-row mt-4">
        ...
        <iframe
          ...
          className="w-full lg:w-[600px] h-[200px] rounded-lg"
          allowFullScreen
          loading="lazy"
