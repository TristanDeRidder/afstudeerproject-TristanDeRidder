...
export default function ContactBanner() {
    ...
    return (
      <div
        className={`bg-secondary text-white p-10 flex flex-col lg:flex-row justify-between items-center gap-8 mx-5 lg:mx-32 rounded-md`}
      >
        <p className="text-4xl md:text-6xl lg:text-7xl text-center lg:text-left w-full lg:w-4/12">
